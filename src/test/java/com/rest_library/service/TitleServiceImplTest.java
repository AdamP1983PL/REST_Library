...
class TitleServiceImplTest {
    ...
    public void givenTitleDtoObject_whenSaveTitle_thenReturnSavedTitleObject() {
        // given
        given(titleRepository.findByBookTitle(testTitle.getBookTitle())).willReturn(Collections.emptyList());
    ...
    public void givenExistingBookTitle_whenSaveTitle_thenThrowsTitleAlreadyExistsException() {
        // given
        List<Title> testTitleList = List.of(testTitle);
        given(titleRepository.findByBookTitle(testTitle.getBookTitle())).willReturn(testTitleList);
